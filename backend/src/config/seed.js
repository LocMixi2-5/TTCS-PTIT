...
async function seedJobs() {
  ...
  // Insert Companies — logo thật từ Clearbit Logo API
  const FAKE_COMPANIES = [
    {
      name: 'TechNova Vietnam',
      logo_url: null, // sẽ dùng Clearbit tự động theo website
      description: 'Công ty công nghệ hàng đầu về AI và Big Data.',
      website: 'https://technova.vn',
    },
    {
      name: 'CloudSync Solutions',
      logo_url: null,
      description: 'Cung cấp giải pháp Cloud và SaaS cho doanh nghiệp.',
      website: 'https://cloudsync.vn',
    },
    {
      name: 'FPT Software',
      logo_url: 'https://logo.clearbit.com/fpt-software.com',
      description: 'Tập đoàn công nghệ hàng đầu Việt Nam.',
      website: 'https://fpt-software.com',
    },
    {
      name: 'VNG Corporation',
      logo_url: 'https://logo.clearbit.com/vng.com.vn',
      description: 'Kiến tạo công nghệ và phát triển hệ sinh thái số.',
      website: 'https://vng.com.vn',
    },
    {
      name: 'Tiki',
      logo_url: 'https://logo.clearbit.com/tiki.vn',
      description: 'Nền tảng thương mại điện tử uy tín.',
      website: 'https://tiki.vn',
    },
    {
      name: 'Shopee Vietnam',
      logo_url: 'https://logo.clearbit.com/shopee.vn',
    ...
    {
      name: 'ZaloPay',
      logo_url: 'https://logo.clearbit.com/zalopay.vn',
      description: 'Ví điện tử quốc dân.',
      website: 'https://zalopay.vn',
    },
    {
      name: 'VNPAY',
      logo_url: 'https://logo.clearbit.com/vnpay.vn',
      description: 'Giải pháp thanh toán VNPAY-QR.',
      website: 'https://vnpay.vn',
    },
    {
      name: 'Viettel Digital',
      logo_url: 'https://logo.clearbit.com/viettel.com.vn',
      description: 'Trung tâm không gian mạng Viettel.',
      website: 'https://viettel.com.vn',
    },
    {
      name: 'Gojek',
      logo_url: 'https://logo.clearbit.com/gojek.com',
      description: 'Ứng dụng gọi xe công nghệ.',
      website: 'https://gojek.com',
    },
    {
      name: 'Be Group',
      logo_url: 'https://logo.clearbit.com/be.com.vn',
      description: 'Nền tảng đa dịch vụ Việt Nam.',
      website: 'https://be.com.vn',
    },
    {
      name: 'AhaMove',
      logo_url: 'https://logo.clearbit.com/ahamove.com',
      description: 'Dịch vụ giao hàng siêu tốc.',
      website: 'https://ahamove.com',
    },
    {
      name: 'Giao Hàng Tiết Kiệm',
      logo_url: 'https://logo.clearbit.com/ghtk.vn',
      description: 'Dịch vụ giao hàng chuyên nghiệp.',
      website: 'https://ghtk.vn',
    },
    {
      name: 'Cốc Cốc',
      logo_url: 'https://logo.clearbit.com/coccoc.com',
      description: 'Trình duyệt web của người Việt.',
